...
import cn.javabook.chapter07.chain.*;
import cn.javabook.chapter07.common.Account;
import cn.javabook.chapter07.common.Order;
import cn.javabook.chapter07.facade.FinanceFacade;
import cn.javabook.chapter07.iterator.Cart;
import cn.javabook.chapter07.iterator.ConcreteCart;
import cn.javabook.chapter07.iterator.Iterator;
import cn.javabook.chapter07.memento.Caretaker;
import cn.javabook.chapter07.memento.Originator;
import cn.javabook.chapter07.observer.AlipayPayment;
import cn.javabook.chapter07.observer.BalancePayment;
import cn.javabook.chapter07.observer.WeixinPayment;
...
public class AppClient {
	...
	public static void main(String[] args) {
		...
		cart.add(new cn.javabook.chapter07.iterator.Product("白菜", 1, 3.8));
		cart.add(new cn.javabook.chapter07.iterator.Product("大米", 1, 88.9));
		cart.add(new cn.javabook.chapter07.iterator.Product("纸巾", 1, 24.8));
		cart.add(new cn.javabook.chapter07.iterator.Product("方便面", 1, 33.7));
